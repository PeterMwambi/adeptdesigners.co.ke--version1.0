    ...
    <div class="container">
        <div class="console-body">
            <div class="d-flex justify-content-center mb-lg-4">
                <h1 class="text-warning">Update Item</h1>
            </div>
            <?php
            if (Input::grab("addsupplier")) {
                ...
                if (!$authenticator->generateUploadRequest("fileToUpload", "../../uploads/supplier/")) {
            ...
            <div class="col-md-12 upload-body">
                <form action="<?php echo htmlspecialchars(""); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="supplier-name" class="text-light">Choose a new supplier name:</label>
                                <input type="text" name="supplier-name" value="<?php echo Sanitize::__string(Input::grab("product-name")); ?>" class="form-control">
                                <span class="text-danger"></span>
                            </div>
                            <div class="form-group">
                                <label for="product-description" class="text-light">Change product description:</label>
                            ...
                            <div class="form-group">
                                <label for="product-price" class="text-light">Choose a new product price:</label>
                                <input type="text" name="product-price" value="<?php echo Sanitize::__string(Input::grab("product-price")); ?>" class="form-control">
                                <span class="text-danger"></span>
                            </div>
                            <div class="form-group">
                                <label for="product-cartegory" class="text-light">Change product cartegory:</label>
                    ...
                    <div class="form-row mt-lg-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="submit" name="addproduct" class="btn btn-lg btn-outline-info" value="Update product &raquo">
                            </div>
                        </div>
                        <div class="col-md-5 ml-lg-5">
                            <div class="form-group">
