         ...
         <div class="d-flex justify-content-center">
             <div class="col-md-9">
                 <div class="d-flex justify-content-end mt-lg-4 mb-lg-n1">
                     ...
                     <a class="btn btn-outline-danger ml-lg-3" href="<?php echo "cart.php?action=emptycart"; ?>">Delete Cart Items</a>
                 </div>
                 <div class="d-flex justify-content-end mt-lg-4 mb-lg-n1">
                     <p>Total Items: <?php echo ($cart->getTotalItems() > 0) ? $cart->getTotalItems() : 0; ?></p>
                 </div>
                 <table class="table mt-lg-3 table-stripped table-hover">
                     <thead>
                         <tr>
                             <th>
                                 Id
                         ...
                         <?php foreach ($cart->displayItems() as $cartItems) { ?>
                             <tr>
                                 ...
                                 <form action="" method="post">
                                     ...
                                     <td>
                                         <div class="delete-item d-flex justify-content-center">
                                             <a href="<?php echo "cart.php?cid=" . $cartItems["items"]["id"] . "&action=delete"; ?>" class="hovereble"> <img src="../Tools/Assets/delete.png" class="img-fluid resized"></a>
                                         </div>
                                     </td>
                                 </form>
                             </tr>
                 ...
                 <div class="d-flex justify-content-center">
                     <a class="btn btn-success w-100 btn-lg" href="checkout.php">Checkout &raquo;</a>
                 </div>
             </div>
         </div>
     </div>
